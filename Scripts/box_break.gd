...
export (Array,PackedScene) var fruits_instance
...
func create_fruits():
	var fruits_numbers = round(rand_range(0, fruits_instance.size() -1 ))
	var fruit = fruits_instance[fruits_numbers].instance() 
