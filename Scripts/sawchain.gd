...
func _start_tween():
	...
	tween.interpolate_property(self,"follow", Vector2.ZERO, move_direction,duration,
		Tween.TRANS_LINEAR,tween.EASE_IN_OUT, WAIT_DURATIN
	)
	tween.interpolate_property(self,"follow",move_direction,Vector2.ZERO,duration,
